...
| f | **Blake to confirm paid-status of 6 pending KC Energy Savers rows on `8617 Houston`** ($9,020.41 total — ids `2c41390e`, `76b66647`, `0bf20161`, `7c528b6b`, `bad03f3d`, `77a23736`) | Read-only audit (2026-07-15) found these logged raw as `status=pending`. If Blake already paid KC in cash they should be `paid` — moves $ from Outstanding→Paid Out. NOT a double-count (no matching sub-invoice); purely a status-accuracy question only Blake can answer. | 2026-07-15 |
| g | **Kalin: did Aguayo's do carpet on `8617 Houston`?** If yes → liability missing from books | Aguayo's has 3 invoices (painting/framing, bathroom remodel, electrical) — NONE for carpet. Carpet on this job was paid to Southside Carpet ($4,647) + Carlos flooring ($4,500), both raw by Kalin. If Aguayo actually did carpet and is owed, that liability is entirely absent from the books (understated). | 2026-07-15 |
