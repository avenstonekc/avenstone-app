...
> **Starting position: SCOPE_CAPTURE_ENGINE BLUEPRINT APPROVED 2026-06-25. Phase 1A dispatch unblocked (consolidate to one generator, retire gefs). Phase 1B blocked on Kalin seed content (blueprint §3.1). B2.1 + B2.2 + B2.3 SHIPPED 2026-06-25.** B2.4 (Scope Risk) gated on SCOPE_CAPTURE_ENGINE Phase 1. Next action: Phase 1A build dispatch (Sonnet).
