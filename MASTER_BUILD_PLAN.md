...
> **Starting position: SCOPE_CAPTURE_ENGINE blueprint (Opus, before B2.4). B2.1 + B2.2 + B2.3 SHIPPED 2026-06-25.** SCOPE_CAPTURE_ENGINE locked 2026-06-25 — blueprint required before build phases begin. B2.4 (Scope Risk) is gated on SCOPE_CAPTURE_ENGINE Phase 1. Blueprint dispatch is the next action.
...
**Block 2 total: ~31-33 prompts** (13 original + 12 FLIP_FINANCIAL_MODEL + ~6-8 SCOPE_CAPTURE_ENGINE pending blueprint, locked 2026-06-25)
...
| 10.5 | SCOPE_CAPTURE_ENGINE — text interview engine (Phase 1); session→estimate auto-flow (Phase 2); vision-reconciliation (Phase 3); role instances Phase 4+ | B2 | ~6-8 (pending blueprint) | ~30-32 (shifts all downstream) | SCOPE_CAPTURE_ENGINE (locked 2026-06-25, blueprint required) |
| 11 | Scope Risk Phase 1: risk source + seed | B2 | 2 | ~32-34 | SCOPE_RISK Phase 1 |
| 12 | Scope Risk Phase 2: estimator integration | B2 | 2 | ~34-36 | SCOPE_RISK Phase 2 |
| 13 | Scope Risk Phase 3: render in proposal | B2 | 2 | ~36-38 | SCOPE_RISK Phase 3 |
...
| 10 | **SCOPE_CAPTURE_ENGINE ↔ B5.1-B5.3 (Client INTAKE): absorb or feed?** B5.1-B5.3 (client self-serve intake) is a role-instance of SCOPE_CAPTURE_ENGINE per the 2026-06-25 lock. The blueprint must decide: (a) ABSORB — SCOPE_CAPTURE_ENGINE builds the engine once and B5.1-B5.3 become a client-role dispatch of it (B5.1-B5.3 effectively replaced), OR (b) FEED — SCOPE_CAPTURE_ENGINE is a separate rep/PM tool and B5.1-B5.3 build their own intake separately (two builds that could drift). Kalin's call before blueprint locks Phase 4 scope. | Architecture decision — determines whether B5.1-B5.3 are still standalone items or folded into SCOPE_CAPTURE_ENGINE Phase 4 |
