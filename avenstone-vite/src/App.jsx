...
import { sb, setSession, sbLoadNotifs, sbMarkNotifsRead, sbSave, sbUpd, setGlobalJobs } from './lib/supabase';
      ...
      <div className="app">
        ...
        <div className="main">
          ...
          <div className="pg-wrap">
            {pg === 'dashboard' && <DashScr nav={setPg} jobs={jobs} profile={profile} />}
