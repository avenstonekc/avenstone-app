// One-shot seed function — populates ai_knowledge for Avenstone (tenant 00000000-0000-0000-0000-000000000001)
// with Kansas City mid-tier GC pricing. Safe to re-run (clears + reinserts).
// Delete this function after running once.

import { createClient } from "https://esm.sh/@supabase/supabase-js@2";

const TENANT = "00000000-0000-0000-0000-000000000001";
const CREATED_BY = "8171742a-b586-4f13-be61-744e191a1896"; // Kalin

const ENTRIES = [
  {
    category: "company_profile",
    content: `COMPANY: Avenstone Contracting (Kansas City, MO)
...
UNIQUE VALUE: AI-assisted project communication, real-time client portal, transparent scheduling`,
  },
  {
    ...
    content: `LABOR RATES — Kansas City Mid-Tier Market (2025–2026)
...
- Prevailing wage (public projects): add 30–50% to above rates`,
  ...
  {
    category: "pricing_demo",
    content: `DEMOLITION & HAULING — Kansas City Mid-Tier
...
ASBESTOS / HAZMAT: Always test before demo on pre-1980 homes. Abatement: $2,500–8,000+ (sub it out, do not estimate without a certified report)`,
  ...
  {
    category: "pricing_concrete",
    content: `CONCRETE & FLATWORK — Kansas City Mid-Tier
...
- Rebar add-on if not included above: $0.50–0.90/sf`,
  },
  {
    category: "pricing_framing",
    content: `FRAMING — Kansas City Mid-Tier

ROUGH FRAMING (labor + material — standard lumber pricing):
...
- Roof framing (engineered trusses): $6.00–9.00/sf (truss cost + set)
- Full addition framing (walls + floor + roof): $18–28/sf of addition

STRUCTURAL:
- Engineered LVL beam (installed, per LF): $35–65/LF (material + labor)
...
NOTES:
- Lumber pricing fluctuates — above includes current 2025 mid-range material costs
- Complex roof geometry (hips, valleys, dormers): +15–25%
- Cathedral/vaulted ceiling framing: +20–30%`,
  },
  {
    category: "pricing_roofing",
    content: `ROOFING — Kansas City Mid-Tier

SHINGLE ROOFING (1 square = 100 sf of roof surface):
...
- Ridge cap: included in above pricing
...
- Roof vents (standard): $80–150 each

MINIMUMS: $2,500 for any roofing work`,
  },
  {
    category: "pricing_windows_doors",
    content: `WINDOWS & DOORS — Kansas City Mid-Tier

WINDOWS (unit price includes installation labor; window material is extra unless noted):
- Window installation labor (standard double-hung, existing opening): $150–300 each
- Window installation (new opening, framing + install): $350–600 each
...
TRIM & HARDWARE: see pricing_cabinets_millwork`,
  },
  {
    category: "pricing_insulation",
    content: `INSULATION — Kansas City Mid-Tier
...
NOTES:
- KC climate (Zone 4–5): R-49 attic and R-21 wall recommended for new construction
- Air sealing before insulation: $500–1,500 per project (worth doing)`,
  },
  {
    category: "pricing_drywall",
    content: `DRYWALL — Kansas City Mid-Tier

INSTALLATION (supply + hang + all finishing):
- Standard 1/2" drywall (Level 4 finish, painted-ready): $1.25–1.85/sf
...
- Drywall over existing popcorn: $0.90–1.40/sf
...
NOTES:
- Level 4 is standard for painted walls in KC
...
- Garage drywall (5/8" Type X): required by code in attached garages`,
  ...
  {
    category: "pricing_painting",
    content: `PAINTING — Kansas City Mid-Tier
...
- Pressure wash + prep (before exterior): $0.15–0.35/sf (add to exterior)

NOTES:
- Premium paint (Sherwin-Williams Duration, Benjamin Moore Aura): add $0.20–0.40/sf
- High ceilings (>10 ft): add 15–20%
- Occupied home protection/masking: add 10%`,
  },
  {
    category: "pricing_flooring",
    content: `FLOORING — Kansas City Mid-Tier (fully installed — material + labor + basic prep)

LUXURY VINYL PLANK (LVP):
- Builder-grade LVP (installed): $3.50–5.00/sf
- Mid-grade LVP (installed, 6–8mm, good brand): $4.50–6.50/sf
...
- Hardwood repair / board replacement: $8–20/sf depending on match
...
TILE (see also pricing_tile for detail):
...
DEMO & PREP:
- Remove existing flooring: $0.85–2.00/sf (more for tile/glue-down hardwood)
- Self-leveling underlayment: $2.00–4.00/sf (only when needed)
- Subfloor repair / sheathing replacement: $4.00–8.00/sf

TRANSITIONS & THRESHOLDS: $25–75 each`,
  },
  {
    category: "pricing_tile",
    content: `TILE WORK — Kansas City Mid-Tier

SHOWER TILE (fully tiled shower, labor + material):
- Ceramic tile shower (standard 4x4 / subway, installed): $12–18/sf
...
- Heated floor mat (electric, under tile, per sf): $9.00–14.00/sf
...
- Laundry room floor: same as bathroom floor
...
- Caulk at transitions: typically included in install price`,
  },
  {
    category: "pricing_cabinets_millwork",
    content: `CABINETS & MILLWORK — Kansas City Mid-Tier

KITCHEN CABINETS (supply + install, measured per LF of base + upper combined):
...
- Typical 25 LF kitchen in quartz: $1,500–2,625
...
- Closet systems (custom, installed): $1,500–6,000 per closet`,
  ...
  {
    category: "pricing_plumbing",
    content: `PLUMBING — Kansas City Mid-Tier (typically subcontracted; prices below are fully installed sub costs)

ROUGH-IN PLUMBING (new work, per fixture unit):
...
FINISH PLUMBING (fixture set, assumes rough already in):
...
- Drain / sewer replace (varies widely): bid only
- Gas line (per LF, new): $25–45/LF
- Pressure test / inspection: $150–300

NOTES: Always get sub bids on plumbing. Use above for ballpark estimate only.`,
  },
  {
    category: "pricing_electrical",
    content: `ELECTRICAL — Kansas City Mid-Tier (typically subcontracted; prices are fully installed sub costs)
...
- Recessed can light (retrofit / existing ceiling): $100–200 each
...
- Smart panel / Span: $3,500–6,000 installed
- Smoke / CO detectors (hardwired, installed): $90–150 each
- Whole-house generator hookup: $1,500–4,000 (generator not included)

NOTES: Always get sub bids. Panel upgrades often need utility coordination — add 1–3 weeks lead time.`,
  },
  {
    category: "pricing_hvac",
    content: `HVAC — Kansas City Mid-Tier (typically subcontracted; prices are fully installed sub costs)
...
- Hyper-heat (cold climate): add $500–1,200
...
- Minimum project: $5,000 (below this, not worth our overhead)
...
CONTINGENCY:
- Remodel / renovation: always add 10% contingency line item (hidden conditions)
- New construction: 5% contingency
- Historic / older home (pre-1970): 15% contingency
- Tell client: contingency is for their protection, unused contingency is returned`,
  },
  {
    category: "draw_schedule",
    content: `DRAW SCHEDULE — Avenstone Standard
...
- Final draw released when: punch list complete + all permits closed + client sign-off`,
  ...
  {
    category: "change_order_policy",
    content: `CHANGE ORDER POLICY — Avenstone

MARKUP ON CHANGE ORDERS:
- Standard CO markup: 15% on all labor and materials
- Minimum CO charge: $300 (covers admin, estimation, scheduling disruption)
...
6. CO becomes part of contract upon signature
...
- Material substitution at client request (upcharge or credit)
...
AI GUIDANCE: When estimating a CO, always check if there are schedule impacts and material lead times before quoting. Flag any COs over $5,000 for PM review before presenting to client.`,
  },
  {
    category: "estimating_guidelines",
    content: `ESTIMATING GUIDELINES — How Avenstone Builds Estimates
...
- If scope is extremely detailed (drawings + specs): can use lower end
...
- Temporary facilities if needed (porta-potty, temp power)
- Final clean
- Contingency line item (labeled as such)
- Overhead + profit (can be labeled "General Conditions + Margin" if needed)

WHAT NOT TO INCLUDE UNLESS ASKED:
- Furniture, appliances (unless client explicitly includes)
- Landscaping (unless part of scope)
- Owner-supplied materials (note: subtract if client supplies)

PRELIMINARY vs. FINAL ESTIMATE:
- Preliminary: range estimate from conversation. 10–15% accuracy. OK to give without site visit.
...
- Show projected start date and completion range`,
  },
  {
    ...
    content: `CLIENT COMMUNICATION GUIDELINES — Avenstone AI

TONE:
- Professional but warm and approachable
- Explain the "why" behind costs and decisions — clients trust contractors who educate them
...
- Translate construction jargon into plain language for clients
...
- Make commitments about warranty beyond 1 year workmanship (state law varies)
- Discuss ongoing litigation or disputes
...
Deno.serve(async (_req) => {
  ...
  if (delErr) {
    return new Response(JSON.stringify({ error: "Delete failed", detail: delErr.message }), { status: 500 });
  }
  ...
  const { error: insErr, data } = await sb.from("ai_knowledge").insert(rows).select("id, category");

  if (insErr) {
    return new Response(JSON.stringify({ error: "Insert failed", detail: insErr.message }), { status: 500 });
  }

  return new Response(
    JSON.stringify({ success: true, inserted: data?.length, categories: data?.map((r: { category: string }) => r.category) }),
