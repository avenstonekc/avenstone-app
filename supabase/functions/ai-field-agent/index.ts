...
// the live field surface is ai-agent/fieldCore.ts, a verbatim copy of this file). This slug stays
// DEPLOYED + UNTOUCHED as the rollback target until field-stable — do NOT add features here; make
// changes in ai-agent/fieldCore.ts. Removal is a later cleanup once the merge is field-proven.
